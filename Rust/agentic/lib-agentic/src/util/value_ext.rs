//--------------------------------------------------------------------------
// Copied from Jeremy Chone's excellent rust-genai project
// from src/support/value_ext.rs. I don't see it anymore at 
// https://github.com/jeremychone/rust-genai/tree/main/src. Maybe he moved 
// it out to another lib.
//
// MIT License
//--------------------------------------------------------------------------
